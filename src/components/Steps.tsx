...
const STEPS = [
  { name: "Step 1: Add image", description: "Choose and image for your case", url: "/upload" },
  { name: "Step 2: Customize design", description: "Make the case yours", url: "/design" },
  { name: "Step 1: Summary", description: "Review your final design", url: "/preview" },
];
...
type StepType = {
  step: { name: string; description: string; url: string };
  index: number;
  imgPath: string;
  isCompleted: boolean;
  isCurrent: boolean;
...
function Step({ step, index, imgPath, isCompleted, isCurrent }: StepType) {
  return (
